...
public class GroupExcludeExecutor implements CommandExecutor {
    ...
    public GroupExcludeExecutor(RegionManager regionManager, GroupManager groupManager) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if(!group.contains(region)) {
            player.sendMessage(Message.regionMissingInGroup(region.getName(), group.getName()));
            return true;
        }
        
        group.remove(region);
        FileManager.save(groupManager);
        player.sendMessage(Message.regionRemovedFromGroup(region.getName(), group.getName()));
